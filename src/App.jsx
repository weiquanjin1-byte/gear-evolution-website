...
import AiProducts from './components/AiProducts.jsx';
import Skills from './components/Skills.jsx';
import Contact from './components/Contact.jsx';
import Footer from './components/Footer.jsx';
import GearDrawingAI from './pages/GearDrawingAI.jsx';

export default function App() {
  if (window.location.pathname === '/gear-drawing-ai') {
    return <GearDrawingAI />;
  }
